...
/**
 * Handles touch events on cards in the players hand. Is the start of drag
 * events.
 */
// This onTouch is never used in lower API versions. See
// GameDeckAdapter.getView
...
public class CardOnTouchListener implements OnTouchListener {
	...
	/**
	 * @param position
	 *            The position in the players hand the touched card has.
	 */
	...
	public boolean onTouch(View v, MotionEvent me) {
		...
		v.startDrag(null, shadow, new CardTouchData((int) me.getRawY(),
				position, v.getHeight(), (int) me.getX(), (int) me.getY()), 0);
		return false;
	}
