...
public class GameHelper implements GoogleApiClient.ConnectionCallbacks,
	...
	/**
	 * Call this method from your Activity's onStop(). Modification by Ambiguous
	 * project. We sometimes do not want to close the connection.
	 * */
	public void onStop(boolean disconnect) {
		debugLog("onStop");
